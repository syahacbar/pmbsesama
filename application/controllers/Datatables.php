...
class Datatables extends CI_Controller
{
    ...
    function kabupaten_list()
    {
        ...
        foreach ($list as $kab) {
            ...
            $row[] = $kab->namakab;
            $row[] = $kab->namaprov;
            $row[] = '<a href="#" class="btn btn-info btn-icon-split btn-sm editdata" data-namaprovinsi="'.$kab->namakab.'" data-kodeprovinsi="'.substr($kab->kode,0,2).'" data-kodekabupaten="'.substr($kab->kode,3,2).'" data-kodewilayah="'.$kab->kode.'"><span class="icon text-white-50"><i class="fas fa-edit"></i></span><span class="text">Edit</span></a>
    ...
    function kecamatan_list()
    {
        ...
        foreach ($list as $kec) {
            ...
            $row[] = $kec->namakab;
            $row[] = $kec->namaprov;
            $row[] = '<a href="#" class="btn btn-info btn-icon-split btn-sm editdata" data-namaprovinsi="'.$kec->namakec.'" data-kodeprovinsi="'.$kec->kode.'" data-kodewilayah="'.$kec->kode.'"><span class="icon text-white-50"><i class="fas fa-edit"></i></span><span class="text">Edit</span></a>
