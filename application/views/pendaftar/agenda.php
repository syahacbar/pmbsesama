      ...
      <div class="row d-flex">
        <div class="col-lg-12">
          <div class="card2 card border-0 px-0 py-0">
            <div class="row mb-2">
              <h4 class="mb-0 mr-4 mt-2">Informasi Panduan Penerimaan Mahasiswa Baru (PMB)</h4>
            </div>
  ...
  <div class="col-lg-4">
    <div class="card alert alert-primary px-0 py-0">
      <div class="card-body px-2 py-2">
        <strong class="card-title"><i class="fas fa-file"></i> SK Penetapan Kelulusan Bersama 2021</strong>
        <p class="card-text">Unduh Dokumen Penting</p>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
