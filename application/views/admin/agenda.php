                            ...
                            <tbody>
                                ...
                                foreach ($agenda as $ag) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info btn-icon-split btn-sm editform" data-agenda="<?php echo $ag['judul'], $ag['isi_agenda'] ?>" data-id="<?php echo $ag['id'] ?>">
                ...
                <div class="card-body">
                    ...
                    <form id="formagenda" action="<?php echo site_url($linkform); ?>" method="post">
                        <div class="form-group">
                            <label>Judul</label>
                            <input id="txtAgenda" type="text" class="form-control" name="agenda" placeholder="Judul Agenda" required>
                            <input type="hidden" id="idagenda" name="idagenda">
                        </div>
                        <div class="form-group">
                            <label>Isi Agenda</label>
                            <textarea id="txtAgenda" class="form-control" name="agenda" placeholder="Isi Agenda" required></textarea>
                            <input type="hidden" id="idagenda" name="idagenda">
                        </div>

                        <!-- <div class="form-group">
                            <label>Gambar Agenda</label>
                            <input class="form-control" placeholder="Gambar Agenda" required></input>
                            <input type="hidden" id="idagenda" name="idagenda">
                        </div> -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#dataTable").on("click", ".editform", function() {
                ...
                $("input#txtAgenda").val($(this).data('agenda'));
