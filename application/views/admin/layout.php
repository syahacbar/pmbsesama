...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo($this->uri->segment(2)=="ref_agama") ? "active" : "";?>">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_agama');?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_statusmenikah');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Status Menikah</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_wilayah');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Wilayah</span></a>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_jenismta');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Jenis SMTA</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_jurusansmta');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Jurusan SMTA</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_pendidikanortu');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pendidikan Orang Tua</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_pekerjaanortu');?>l">
                    <i class="fas fa-fw fa-table"></i>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo base_url();?>/assets/backend/startbootstrap/img/undraw_profile_1.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo base_url();?>/assets/backend/startbootstrap/img/undraw_profile_2.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo base_url();?>/assets/backend/startbootstrap/img/undraw_profile_3.svg"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url();?>/assets/backend/startbootstrap/img/undraw_profile.svg">
                            </a>
