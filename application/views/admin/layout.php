        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if ($this->ion_auth->in_group('admin')) { ?>
                ...
                <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_jenissmta" || $this->uri->segment(2) == "ref_jurusansmta"|| $this->uri->segment(2) == "ref_namasmta") ? "active" : ""; ?>">
                    ...
                    <div id="collapseIdentitasSekolah" class="collapse <?php echo ($this->uri->segment(2) == "ref_jenissmta" || $this->uri->segment(2) == "ref_jurusansmta" || $this->uri->segment(2) == "ref_namasmta") ? "show" : ""; ?>" aria-labelledby="headingIdentitasSekolah" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item <?php echo ($this->uri->segment(2) == "ref_namasmta") ? "active" : ""; ?>" href="<?php echo site_url('administrator/ref_namasmta'); ?>">Nama SMTA</a>
                        </div>
                    </div>
                </li>
