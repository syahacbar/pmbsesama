...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_statusmenikah") ? "active" : ""; ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_jenissmta") ? "active" : ""; ?>">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_jenissmta'); ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Jenis SMTA</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_jurusansmta") ? "active" : ""; ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_pendidikanortu") ? "active" : ""; ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_pekerjaanortu") ? "active" : ""; ?>">
                <a class="nav-link" href="<?php echo site_url('administrator/ref_pekerjaanortu'); ?>">
                    <i class="fas fa-fw fa-table"></i>
