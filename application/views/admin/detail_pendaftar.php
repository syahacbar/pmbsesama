...
<!--                 <div class="sidebar-brand-icon rotate-n-15">
            ...
            <li class="nav-item <?php echo ($this->uri->segment(2) == "") ? "active" : ""; ?>">
                ...
                <div id="collapsePendaftaran" class="collapse <?php echo ($this->uri->segment(2) == "datapendaftar" || $this->uri->segment(2) == "slider" || $this->uri->segment(2) == "agenda" || $this->uri->segment(2) == "informasi") ? "show" : ""; ?>" aria-labelledby="headingPendaftaran"
...
<!--                 <li class="nav-item <?php // echo ($this->uri->segment(2) == "pengaturan") ? "active" : ""; ?>">
        ...
        <li class="nav-item <?php echo ($this->uri->segment(2) == "ref_fakultas" || $this->uri->segment(2) == "ref_prodi") ? "active" : ""; ?>">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePilihanprodi"
            aria-expanded="true" aria-controls="collapsePilihanprodi">
            <i class="fas fa-fw fa-building"></i>
            <span>Pilihan Program Studi</span>
        </a>
        <div id="collapsePilihanprodi" class="collapse <?php echo ($this->uri->segment(2) == "ref_fakultas" || $this->uri->segment(2) == "ref_prodi") ? "show" : ""; ?>" aria-labelledby="headingPilihanprodi"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
				...
				<div class="col-lg-12">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Detail Data Pendaftar Jalur SESAMA</h6>
						</div>
						<div class="card-body">
						                    ...
						                    <div class="row">
												<table class="table table-sm">
												  <tbody>
												    ...
												    <tr>
												      <td>Nilai Rapor Kelas XI semeseter 1</td>
												      <td>:</td>
												      <td><?php echo $p['nrapor1']; ?></td>
												    </tr>
												    <tr>
												      <td>Nilai Rapor Kelas XI semeseter 2</td>
												      <td>:</td>
												      <td><?php echo $p['nrapor2']; ?></td>
												    </tr>
												    <tr>
												      <td>Nilai Rapor Kelas XII semeseter 1</td>
												      <td>:</td>
												      <td><?php echo $p['nrapor3']; ?></td>
												    </tr>
												    <tr>
												      <td>Lampiran Rapor Kelas XI semeseter 1</td>
												      <td>:</td>
												      <td>
												    ...
												    <tr>
												      <td>Lampiran Kelas XI semeseter 2</td>
												      <td>:</td>
												      <td>
												      	<a href="<?php echo $p['beratbadan']; ?>" class="btn btn-info btn-sm">
												      	Unduh File
												    ...
												    <tr>
												      <td>Lampiran Kelas XII semeseter 1</td>
												      <td>:</td>
												      <td>
												      	<a href="<?php echo $p['beratbadan']; ?>" class="btn btn-info btn-sm">
												      	Unduh File
